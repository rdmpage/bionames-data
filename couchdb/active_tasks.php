...
while (true)
{
	...
	{
		echo $obj->database . ' ' . str_pad($obj->design_document, 25);
		
		switch ($obj->type)
		{
			case 'indexer':
				echo ' indexing    ';
				echo str_pad($obj->changes_done . '/' . $obj->total_changes . ' (' . $obj->progress . '%)',20, ' ', STR_PAD_LEFT);
				break;
			...
			case 'replication':
				echo ' replication ';
				echo str_pad(' (' . $obj->progress . '%)',20, ' ', STR_PAD_LEFT);
				break;
